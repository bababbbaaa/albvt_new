<template>
  <div class="bg-[#F9F9F9]">
    <div class="pt-8 mt-8" v-if="usersPermissionsUser">
      <div class="container flex flex-col h-full justify-between gap-8">
        <div class="grid grid-cols-1  w-full gap-2">
          <div class="flex justify-between flex-nowrap items-center mb-4">
            <span class="w-full">{{ $auth.user.FIO_user }}</span>
            <div class="flex flex-col gap-2 text-sm">
              <button @click="handleLogout()" class="flex items-center gap-2 w-full justify-between">
                Выйти
                <svg
              ...
              <nuxt-link to="/doctor/me" class="flex items-center gap-2 w-full justify-between">
              Аккаунт
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
