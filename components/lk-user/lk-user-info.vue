<template>
  <div
    class=" bg-white rounded-[5px] shadow-md flex flex-col h-full max-h-[240px]"
  >
    <div class="bg-[#EDEDED] p-4  flex flex-col gap-4 font-medium text-[18px]">
      <span class=" capitalize">{{ $auth.user.FIO_user }}</span>
    </div>
