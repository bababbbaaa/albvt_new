<template>
  ...
  >
    ...
    <div
      ...
      class="col-span-4 lg:col-span-2 xl:col-span-1  w-full flex items-center justify-center py-2 gap-2"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      <span class=" text-start text-danger text-xs">Временно недоступен</span>
    </div>
    <button
